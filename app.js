...
app.get('/Travel_destination',welcome, trackUrl, trackIP, trackDate, (req, res) => {
  ...
  <body>
    <div class="container">
      ...
      <h3>3. Create your own happiness</h3>
      <p>hiking.</p>
      <img src="https://images.unsplash.com/photo-1552034557-40f8dfe7f2a3" alt="[Activity Name]">
      <h3>4. hello</h3>
      <p>paragliding.</p>
      <img src="https://images.unsplash.com/photo-1591539568451-bc347f70b418" alt="create your own happiness">
...
app.get('/travel.html',welcome, trackUrl, trackIP, trackDate, (req, res) => {
  res.sendFile(path.join(__dirname, 'travel.html'));
});

app.get('/contact_us.html',welcome, trackUrl, trackIP, trackDate, (req, res) => {
  res.sendFile(path.join(__dirname, 'contact_us.html'));
});

app.get('/travel_pac.html',welcome, trackUrl, trackIP, trackDate, (req, res) => {
  res.sendFile(path.join(__dirname, 'travel_pac.html'));
});
app.get('/index.html',welcome, trackUrl, trackIP, trackDate, (req, res) => {
